          ...
          <div className="hero-grid">
            <div className="hero-copy reveal visible">
              ...
              <div className="hero-actions">
                <button className="button button-primary" onClick={() => go("/contact")}>{t.cta}</button>
                <a className="button button-ghost" href="#/gallery" onClick={(e) => { e.preventDefault(); go("/gallery"); }}>{t.galleryH}</a>
              </div>
            </div>
            {!isMobile && (
      ...
      <section className="section section-tight home-projects">
        <div className="shell">
          ...
          <div style={{ marginTop: 24 }} className="reveal home-projects-cta">
            <a className="button button-secondary" href="#/gallery" onClick={(e) => { e.preventDefault(); go("/gallery"); }}>
              {t.galleryShowAll}
            </a>
          </div>
        </div>
