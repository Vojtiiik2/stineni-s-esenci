      ...
      <section className="section home-feature">
        <div className="shell grid-2 feature-split">
          <div className="feature-media reveal">
            <img
              src="assets/img/Onas/onas-03.webp"
  ...
  return (
    <>
      ...
      <section className="section section-tight">
        <div className="shell">
          <div className={isMobile ? "section-header visible" : "section-header reveal visible"}>
            <h2 className="display h2">
          ...
          <div className={isMobile ? "ow-rows visible" : "ow-rows reveal visible"}>
        ...
        <div className="shell">
          ...
          <div className="partner-grid">
            {PARTNERS.map((partner) => (
              <article className={isMobile ? "card partner-card visible" : "card partner-card reveal visible"} key={partner.key}>
                <h3>{partner.name}</h3>
