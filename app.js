      ...
      <section className="section">
        <div className="shell">
          <div className="section-header reveal pricing-header">
            <h2 className="display h2 pricing-section-title">
              {isMobile ? (t.pricingSectionTitleMobile || t.pricingSectionTitle) : t.pricingSectionTitle}
            </h2>

            {isMobile ? (
              <>
                <p className="lead pricing-intro-mobile">{t.pricingIntroMobileShort || (t.pricingIntroMobile || []).join(" ")}</p>

                {!!(t.pricingMobilePoints || []).length && (
                  <ul className="pricing-mobile-points" aria-label={t.pricingMobilePointsLabel || undefined}>
