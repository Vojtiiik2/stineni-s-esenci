...
window.STR = {
  cs: {
    ...
    homeServicesLeadMobile:
      "Na telefonu ukazujeme výběr. Pro další řešení přejeďte do strany.",
    ...
    homeProjectsLeadMobile: "Ukázka vybraných realizací. Další fotografie najdete v celé galerii.",
...
uploadSelectedMany: "souborů vybráno",
  ...
  en: {
    ...
    homeServicesLeadMobile:
      "On mobile we show a selection only. Swipe sideways to see more options.",
    ...
    homeProjectsLeadMobile: "A selection of completed projects. You can open the full gallery for more.",
    benefitDetailLabel: "Detail",
