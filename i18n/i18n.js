...
window.STR = {
  cs: {
    ...
    a11yLangSwitcher: "Přepínač jazyka",
    a11yMenu: "Menu",
...
Každý detail ladíme podle vás. Respektujeme vaše potřeby a přizpůsobujeme se tomu, co je pro vás důležité. Někdo chce klid a měkké světlo, jiný funkční zatemnění nebo jednoduché řešení bez zbytečností. Vždy hledáme cestu, která dává smysl právě vám.`,
   ...
   homeAboutExtra: `Jsme česká rodinná firma a zakládáme si na kvalitě a precizním provedení. Máme více než dvacet let zkušeností s látkami, šitím i technikou. Navrhujeme stínění na míru od první konzultace až po finální realizaci tak, aby výsledek fungoval dlouhodobě.
  ...
  },
 {
  ...
  subtypes: [
    ...
    },
    {
      ...
      tiersTitle: "Typy",
      tiers: [
        { name: "Ovládání", note: "Vypínač, ovladač nebo chytrá domácnost." },
        { name: "Tichý chod", note: "Plynulý pohyb pro každodenní používání." },
        { name: "Na míru", note: "Podle délky, textilu a dispozice prostoru." }
      ]
    },
    {
      key: "garnyze",
...
},
{
  ...
  serviceOnlyNote: "Servis poskytujeme pouze na naše realizace."
    ...
    gallerySectionTitle: "Když stínění naváže na charakter interiéru",
    ...
    essenceLeadMobile:
      "Esence vnímáme jako jemnou vrstvu atmosféry, ne jako hlavní téma interiéru.",
...
rights: "Všechna práva vyhrazena.",
  ...
  en: {
    ...
    a11yLangSwitcher: "Language switcher",
    a11yMenu: "Menu",
...
heroKicker: "Jana Segelberg · Interior Window Treatments",
    ...
    heroTitleMobile: "Curtains, drapes, blinds and tracks made to fit",
    heroLead: "We design window treatments around the room, the light and how the interior is used.",
    heroLeadMobile: "We design window treatments around the room, the light and how the interior works.",
...
Every detail is tailored to you. We respect your needs and adapt to what matters most. Whether you are looking for calm and soft light, effective blackout or a clean and simple solution, we always look for an approach that makes sense for you and your space.`,
    ...
    homeLuxuryLead: "You can see it in the result. In the proportion, the material and in how the room works every day.",
    homeProjectsLeadMobile: "",
...
homeFinalCtaLocation:
  "Prague and surrounding areas. Consultation directly in your interior.",
    ...
    processLeadMobile:
      "From measurement to final styling. Clear, step by step.",
    processQuoteTitle: "The result should feel natural",
    processShowDetail: "Show detail",
    processHideDetail: "Hide detail",
...
pricingItems: [
  ...
  },
  {
    ...
    subtypes: [
      ...
      },
      {
        ...
        rangesTitle: "Guide prices",
        ranges: [
          { label: "small window (200 x 270cm)", value: "CZK 38,400–69,500" },
          { label: "large window (500 x 290cm)", value: "CZK 51,200–78,900" }
        ],
        rangesNote: "The guide price includes design according to the space, measuring, production, installation and final styling.",
        tiersTitle: "Types",
        tiers: [
          { name: "Control", note: "Switch, remote control or smart home." },
          { name: "Quiet movement", note: "Smooth motion for everyday use." },
          { name: "Made to measure", note: "According to length, textile and room layout." }
        ]
      },
      {
        key: "garnyze",
  ...
  },
  {
    ...
    galleryLeadMobile: "A faster mobile overview of completed projects.",
    ...
    gallerySectionLeadMobile: "A selection of completed projects. Tap any photo to open it.",
    ...
    essenceLeadMobile:
      "We see essential oils as a subtle atmospheric layer, not as the main topic of the interior.",
