...
pricingSectionTitleMobile: "Co ovlivňuje cenu stínění",
pricingOpenButton: "Zobrazit orientační ceny",

pricingIntroMobileShort: "Orientační cena se liší podle prostoru, materiálu a typu řešení.",
pricingMobilePointsLabel: "Cenu ovlivňuje hlavně",
pricingMobilePoints: ["rozměry oken", "vybraný materiál", "typ stínění a provedení"],
pricingIntroMobileNote: "Níže najdete orientační přehled pro rychlou představu.",
pricingIntroMobile: [
...
pricingSectionTitleMobile: "What affects the price of shading",
pricingOpenButton: "View guide prices",

pricingIntroMobileShort: "Guide pricing varies depending on the space, the material and the type of solution.",
pricingMobilePointsLabel: "The price is shaped mainly by",
pricingMobilePoints: ["window dimensions", "selected material", "type of shading and finish"],
pricingIntroMobileNote: "Below you will find an indicative overview for a quick first impression.",
pricingIntroMobile: [
