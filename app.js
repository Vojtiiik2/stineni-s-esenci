        ...
        {small ? (
          ...
          <div className="hero-grid">
            <div className="hero-copy reveal visible">
              ...
              <span className="script">{t.brand2}</span>
              <h1 className="display h1">{(t.heroSlides && t.heroSlides[0] && t.heroSlides[0].h1)}</h1>
...
function Home({ t }) {
  ...
  const projectsLead = isMobile ? (t.homeProjectsLeadMobile || t.homeCtaLocation) : t.homeCtaLocation;
      ...
      <section className="section section-tight home-projects">
        <div className="shell">
          <div className="section-header reveal">
            ...
            <p className="lead">{projectsLead}</p>
          </div>
            ...
            <div className="mobile-only mobile-inline-cta reveal">
              <div className="card card-inner mobile-inline-cta-card mobile-inline-cta-accent">
                <h3 className="display h3">
                  {t.mobileProjectsCtaTitle}
                </h3>
                <p className="copy">
                  {t.mobileProjectsCtaText}
                </p>
                <div className="mobile-inline-cta-actions">
                  <button className="button button-primary" onClick={() => go("/contact")}>
                    {t.cta}
